...
@section('backend-content')
    ...
    <section class="content">
        ...
        <div class="alert alert-info alert-dismissible">
            ...
            <h4><i class="icon fa fa-info"></i>{!! trans('messages.Adwords_step1_lbl1') !!}</h4>
            {!! trans('messages.Adwords_step1_lbl2') !!}
        </div>


        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">{!! trans('messages.Adwords_step1_lbl1') !!} </h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form">
