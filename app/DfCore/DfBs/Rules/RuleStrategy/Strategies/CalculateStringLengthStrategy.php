...
class CalculateStringLengthStrategy implements iContract
{
    /**
    ...
    public function handle($es_record, $then_field, $then_field_values,$then_spacing)
    {
        ...
        if(isset($es_record['_source'][$then_field])) {
           if(isset($es_record['_source'][$field])) {
               $es_record['_source'][$then_field] = strlen($es_record['_source'][$field]);
           }
        }
    ...
    {
        return RuleConditions::THEN_CALCULATE_STRING_LENGTH;
    }
