 ...
 */
class Shopmania extends AbstractChannel
    implements iExportChannel
{
    ...
    {
        return $this->buildFeed($this->feed_data,$this->mapping_template, $this->custom_fields,'products',[],$this->root_node);
